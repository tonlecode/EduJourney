...
export default function Index() {
  ...
  const videoUrls = [
    "https://www.youtube.com/embed/iSq63-rT47c",
    "https://www.youtube.com/embed/iSq63-rT47c",
    "https://www.youtube.com/embed/iSq63-rT47c",
    "https://www.youtube.com/embed/iSq63-rT47c",
    "https://www.youtube.com/embed/iSq63-rT47c",
  ...
  return (
	...
	{/* YouTube Videos */}
	<div className="bg-blue-100 rounded-xl overflow-hidden transition-all duration-300 my-4 p-4">
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
    {videoUrls.map((url, index) => (
	<div key={index} className="relative w-full pb-[56.25%] h-0 overflow-hidden rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl">
	  <iframe
