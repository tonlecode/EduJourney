...
<div class="flex items-center justify-between bg-white p-4 rounded shadow mb-6">
    <div class="flex items-center gap-4">
        <a href="/postbuddha/buddha" class="text-gray-700">
...
<!-- Form for Editing Buddha -->
<form action="{{ route('buddha.update', $buddha->id) }}" method="POST" class="space-y-4">
    @csrf
    @method('PUT')
    ...
    <div class="mb-4">
        ...
        <input type="url" name="youtubeLink" id="youtubeLink" value="{{ $buddha->youtube_link }}" required
    ...
    <div class="mb-4">
        ...
        <input type="text" name="name" id="name" value="{{ $buddha->name }}" required
            class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:ring-cyan-500 focus:border-cyan-500 p-2">
    </div>
    ...
    <div class="mb-4">
        ...
        <input type="date" name="date" id="date" value="{{ $buddha->date }}" required
                    class="mt-1 block w-full rounded-xl border-gray-300 shadow-sm focus:ring-cyan-500 focus:border-cyan-500 p-2">
    </div>

    <!-- Buttons -->
    <div class="flex justify-end space-x-3 mt-6">
        <a href="/postbuddha/buddha" class="bg-gray-500 hover:bg-gray-600 text-white py-2 px-4 rounded-full transition-colors duration-300">
            ត្រឡប់ក្រោយ
        </a>
